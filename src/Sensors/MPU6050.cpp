...
MPU6050::MPU6050(uint8_t mpuAddress, uint8_t gyro, uint8_t accel, LED* led){
    ...
    I2CWriteToReg(mpuAddress, 0x6B, 0b10000000, led);
    _delay_ms(100);

    //clear the sleep bit of the MPU 
    I2CWriteToReg(mpuAddress, 0x6B, 0x00, led);
    ...
    * 0bxxx11xxx for 2000 deg/s, sens 16.4                  */
    I2CWriteToReg(mpuAddress, 0x1B, gyro, led);
    ...
    * 0bxxx11xxx for +/- 16 deg/s                                */
    I2CWriteToReg(mpuAddress, 0x1C, accel, led);
